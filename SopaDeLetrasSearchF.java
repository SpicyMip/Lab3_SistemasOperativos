...
public class SopaDeLetrasSearchF {
    ...
    public static void main(String[] args) {
        try {
            ...
            String resultado = tareaPrincipal.join();
            pool.shutdown();
            if (resultado.equals("")) {
    ...
    static class SopaDeLetrasTask extends RecursiveTask<String> {
        private char[][] matriz;
        ...
        protected String compute() {
            ...
            if (palabraEncontrada){
                ...
                SopaDeLetrasTask cuadranteNorteOeste = new SopaDeLetrasTask(matriz, palabraBuscar, filaInicio, mitadFila, columnaInicio, mitadColumna, umbral);
                SopaDeLetrasTask cuadranteNorteEste = new SopaDeLetrasTask(matriz, palabraBuscar, filaInicio, mitadFila, mitadColumna, columnaFin, umbral);
                SopaDeLetrasTask cuadranteSurOeste = new SopaDeLetrasTask(matriz, palabraBuscar, mitadFila, filaFin, columnaInicio, mitadColumna, umbral);
                SopaDeLetrasTask cuadranteSurEste = new SopaDeLetrasTask(matriz, palabraBuscar, mitadFila, filaFin, mitadColumna, columnaFin, umbral);

                invokeAll(cuadranteNorteOeste, cuadranteNorteEste, cuadranteSurOeste, cuadranteSurEste);
                return cuadranteNorteOeste.join() + cuadranteNorteEste.join() + cuadranteSurOeste.join() + cuadranteSurEste.join();
            }
        }
